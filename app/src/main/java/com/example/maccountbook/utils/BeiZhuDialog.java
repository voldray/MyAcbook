...
public class BeiZhuDialog extends Dialog implements View.OnClickListener {
    ...
    OnEnsureLinstener onEnsureLinstener;

    //设定回调接口的方法
    public void setOnEnsureLinstener(OnEnsureLinstener onEnsureLinstener) {
    ...
    public interface OnEnsureLinstener{
